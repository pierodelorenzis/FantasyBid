-- Completa la funzione di chiamata atomica registrando il movimento nel
-- Tavolo dell'asta. Sostituisce la funzione installata con la migrazione 007.
...
begin
  ...
  values (
    ...
    'chiama ' || v_selected_player.name
  );

  return jsonb_build_object(
    'playerId', v_selected_player.id,
    'playerName', v_selected_player.name,
    'status', 'paused',
